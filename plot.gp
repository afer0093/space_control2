...
set output 'images/angular_velocity_omega_x.png'
...
set output 'images/angular_velocity_omega_y.png'
...
set output 'images/angular_velocity_omega_z.png'
...
set output 'images/quaternion_q_x.png'
...
set output 'images/quaternion_q_y.png'
...
set output 'images/quaternion_q_z.png'
...
set output 'images/quaternion_q_w.png'
...
set output 'images/error_and_sqrt_p_q_x.png'
...
set output 'images/error_and_sqrt_p_q_y.png'
...
set output 'images/error_and_sqrt_p_q_z.png'
...
set output 'images/error_and_sqrt_p_q_w.png'
...
set output 'images/error_and_sqrt_p_omega_x.png'
...
set output 'images/error_and_sqrt_p_omega_y.png'
...
set output 'images/error_and_sqrt_p_omega_z.png'
